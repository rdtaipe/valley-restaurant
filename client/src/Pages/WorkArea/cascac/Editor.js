...
function undoChangeText({ prev, next, id }, editor) {
  if (editor.getViewport().getInfo(id)) {
...
export default class Editor extends React.PureComponent {
  constructor(props) {
    ...
    this.horizontalGuides = React.createRef();
    this.verticalGuides = React.createRef();
    this.infiniteViewer = React.createRef();
    this.selecto = React.createRef();
    this.menu = React.createRef();
    this.moveableManager = React.createRef();
      ...
      <div className={prefix("editor")} ref={this.editorElement}>
        ...
        <InfiniteViewer
          ...
          onDragStart={(e) => {
            ...
            if (
              target.nodeName === "A" ||
              moveableManager.current?.getMoveable()
  ...
  removeElements(targetsis, Restore) {
    const viewport = this.getViewport();
